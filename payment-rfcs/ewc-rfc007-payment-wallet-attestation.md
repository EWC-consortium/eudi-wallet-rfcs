...
- [6.0 Verifiable Credential Type](#60-verifiable-credential-type)
- [7.0	Schema Definitions - Payment Wallet Attestation](#70schema-definitions---payment-wallet-attestation)
...
# 6.0 Verifiable Credential Type
...
# 7.0	Schema Definitions - Payment Wallet Attestation
